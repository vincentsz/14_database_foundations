...
--     amount - The amount of money placed for each individual bid by a bidder. T
...
-- benefit of \copy: use relative path instead of absolute

-- HEADER tells postgres to expect a header at first line of cvs file

-- CSV tells postgres that we are importing a csv file
